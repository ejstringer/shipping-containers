...
ggsave('./figures/Richard/pest_counts_comparison_DNA.png',
...
ggsave('./figures/Richard/pest_counts_hist_DNA.png',
...
ggsave('./figures/Richard/pest_counts_comparison_RNA.png',
       width = 5, height = 3.5)
...
ggsave('./figures/Richard/pest_counts_hist_RNA.png',
       width = 4.2, height = 3.5)
